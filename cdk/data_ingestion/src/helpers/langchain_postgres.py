...
def _get_embedding_collection_store(table_name: str, vector_dimension: Optional[int] = None) -> Any:
    global _classes
    ...
    class CollectionStore(Base):
        ...
        __tablename__ = f"langchain_pg_collection_{table_name}"
    ...
    class EmbeddingStore(Base):
        ...
        __tablename__ = f"langchain_pg_embedding_{table_name}"
        ...
        # Include table_name in the index name to ensure uniqueness
        __table_args__ = (
            sqlalchemy.Index(
                f"ix_cmetadata_gin_{table_name}",
                "cmetadata",
...
class PGVector(VectorStore):
    ...
    def __init__(
        ...
        *,
        ...
        self.table_name = self.collection_name + '_table' # New table name!
    ...
    def __post_init__(
        ...
        EmbeddingStore, CollectionStore = _get_embedding_collection_store(
            table_name=self.table_name, # Passing table_name here
