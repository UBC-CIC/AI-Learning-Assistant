...
```
cdk deploy --all \
 --parameters <your-stack-prefix>-Amplify:githubRepoName=AI-Learning-Assistant \
...
For example:
```
cdk deploy --all --parameters AILA-Amplify:githubRepoName=AI-Learning-Assistant --context StackPrefix=AILA --profile <your-profile-name>
```
